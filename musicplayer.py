...
<body>
    ...
    <header>
        ...
        <a href="#" class="logo">FlowerFusion<span>.</span></a>
        <nav class="navbar">
            <a href="#home">Home</a>
...
<section class="footer">
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#">Andhrapradhesh,Nandyal</a>
          <img src="/images/payment.png" alt="">
       
        </div>
    </div>
    <div class="credit">
        &copy; Created by <span> Madimi Deekshitha</span> All Right Reserved.
    </div>
</section>
